    ...
    <main className="bg-background text-foreground min-h-screen px-4 sm:px-12 py-8 space-y-12">
      ...
      <header className="flex justify-between items-center flex-col sm:flex-row space-y-2 sm:space-y-0">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Link href="/login" className="bg-neon text-background px-4 py-2 rounded shadow-neon hover:shadow-pinkGlow hover:shadow-neon transition-shadow font-semibold">
            Login
          </Link>
        </div>
      </header>
      ...
      <section className="text-center">
        ...
        <div className="mt-8 flex flex-col items-center space-y-6 sm:flex-row sm:space-y-0 sm:space-x-8 justify-center">
          <img
            ...
            className="mx-auto rounded-xl shadow-xl shadow-neon/30 max-w-full sm:max-w-md"
          />
          <Link
            href="/login"
            className="bg-neon text-background px-6 py-3 rounded shadow-neon hover:shadow-pinkGlow hover:shadow-neon transition-shadow font-semibold"
          >
            See It In Action
          </Link>
        </div>
      ...
      <section className="bg-card rounded-xl p-6 max-w-4xl mx-auto text-center mt-12 space-y-4 shadow hover:shadow-neon transition-shadow">
        <h2 className="text-xl font-semibold text-neon">Trusted by founders, creators, and tech-savvy investors</h2>
        <p className="text-gray-400 italic">“Finally a dashboard that actually pulls everything into one place.”</p>
        <p className="text-gray-400 italic">“Feels like Notion met my bank account and had a baby.”</p>
      </section>
      ...
      <section className="grid sm:grid-cols-3 gap-6 mt-12">
        {[
          ...
          <div
            key={title}
            className="bg-background border border-neon/40 rounded-xl p-6 hover:border-neon shadow transition-all duration-200"
          >
      ...
      <footer className="pt-12 border-t border-gray-700 text-sm text-gray-500 text-center space-y-2">
        <div className="space-x-4">
          ...
          <Link href="mailto:hello@profolio.app" className="hover:text-neon transition-colors">Contact</Link>
        </div>
