...
let YahooFinanceService = YahooFinanceService_1 = class YahooFinanceService {
    constructor() {
        this.logger = new common_1.Logger(YahooFinanceService_1.name);
        this.userAgents = [
    ...
    async getCurrentPrice(symbol) {
        ...
        try {
            ...
            if (!((_c = result === null || result === void 0 ? void 0 : result.meta) === null || _c === void 0 ? void 0 : _c.regularMarketPrice)) {
    ...
    async getHistoricalData(symbol, days) {
        ...
        try {
            ...
            const data = await this.makeRequest(url);
            const result = (_b = (_a = data.chart) === null || _a === void 0 ? void 0 : _a.result) === null || _b === void 0 ? void 0 : _b[0];
            if (!(result === null || result === void 0 ? void 0 : result.timestamp) || !((_d = (_c = result === null || result === void 0 ? void 0 : result.indicators) === null || _c === void 0 ? void 0 : _c.quote) === null || _d === void 0 ? void 0 : _d[0])) {
